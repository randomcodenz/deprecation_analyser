...
module RailsDeprecationLogAnalyser
  module Filter
    RSpec.describe DeprecationWarning do
      subject(:filter) { DeprecationWarning.new }
      ...
      describe '#match?' do
        ...
        context 'when the line contains `DEPRECATION WARNING: ` but does not start with it' do
      ...
      describe '#clean' do
        ...
        context 'when the line starts with `DEPRECATION WARNING: `' do
          ...
          it 'strips the `DEPRECATION WARNING: ` leader from the line' do
