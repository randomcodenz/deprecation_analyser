...
module RailsDeprecationLogAnalyser
  module Classifier
    class EachWithObjectParameters < Base
      def match?(log_line)
        log_line.include?('Method each_with_object is deprecated and will be removed in Rails 5.1, as `ActionController::Parameters` no longer inherits from hash. Using this deprecated behavior exposes potential security problems. If you continue to use this method you may be creating a security vulnerability in your app that can be exploited.')
      end
