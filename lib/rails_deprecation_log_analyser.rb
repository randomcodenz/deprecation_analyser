...
require 'rails_deprecation_log_analyser/classifier/class_arguement_in_active_record_query'
...
require 'rails_deprecation_log_analyser/classifier/restrict_dependent_destroy_classifier'
