...
module RailsDeprecationLogAnalyser
  module Classifier
    class ExceptParameters < Base
      def match?(log_line)
        log_line.include?('Method except! is deprecated and will be removed in Rails 5.1, as `ActionController::Parameters` no longer inherits from hash. Using this deprecated behavior exposes potential security problems. If you continue to use this method you may be creating a security vulnerability in your app that can be exploited.')
      end
      ...
      def build_deprecation_warning(lines)
        warning = DeprecationWarning.new(
          ...
          summary: 'Method except! is deprecated and will be removed in Rails 5.1, as `ActionController::Parameters` no longer inherits from hash.',
